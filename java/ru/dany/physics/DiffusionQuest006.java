...
public class DiffusionQuest006 extends AppCompatActivity {
    ...
    String[] variant = {"постоянно хаотично движущаяся", "не имеет постоянной формы и объема", "мельчайшая частица вещества"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textQuest.setText("Выберите из списка соответствующее объекту описание");
        textView1.setText("молекула");
        textView2.setText("броуновская частица");
        textView3.setText("газ");
        ...
        View.OnClickListener ok = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flagSpinner1 && flagSpinner2 && flagSpinner3) {
                    Intent intent = new Intent(DiffusionQuest006.this, FinishClass.class);
