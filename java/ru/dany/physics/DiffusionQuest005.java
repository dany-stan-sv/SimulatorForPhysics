...
public class DiffusionQuest005 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textUtterance.setText("На расстояниях, сравнимых с размерами самих молекул, заметнее проявляется (1), а при дальнейшем сближении (2)");
        ...
        editText1.addTextChangedListener(new TextWatcher(){
            ...
            public void afterTextChanged(Editable s) {
                ...
                flagText1 = s.toString().equals("ПРИТЯЖЕНИЕ");
            }
            @Override
        ...
        editText2.addTextChangedListener(new TextWatcher(){
            ...
            public void afterTextChanged(Editable s) {
                // Прописываем то, что надо выполнить после изменения текста
                flagText2 = s.toString().equals("ОТТАЛКИВАНИЕ");
            }
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            }
        ...
        View.OnClickListener ok = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flagText1 && flagText2) {
                    Intent intent = new Intent(DiffusionQuest005.this, DiffusionQuest006.class);
