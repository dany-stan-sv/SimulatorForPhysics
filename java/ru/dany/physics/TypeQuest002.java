...
public class TypeQuest002 extends AppCompatActivity {
        ...
        View.OnClickListener ok = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flagText1 && flagText2) {
                    Intent intent = new Intent(TypeQuest002.this, TypeQuest003.class);
