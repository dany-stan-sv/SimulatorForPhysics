...
public class PressureQuest002 extends AppCompatActivity {

    Button buttonOk;
    boolean flagSpinner1 = false;
    boolean flagSpinner2 = false;
    boolean flagSpinner3 = false;
    int rightPosition1 = 1;
    int rightPosition2 = 2;
    int rightPosition3 = 0;
    String[] variant = {"площадь", "давление", "сила", };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textQuest.setText("Выберите из списка соответствующую обозначению физическую величину");
        textView1.setText("p");
        textView2.setText("F");
        textView3.setText("S");
        ...
        View.OnClickListener ok = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (flagSpinner1 && flagSpinner2 && flagSpinner3) {
                    Intent intent = new Intent(PressureQuest002.this, PressureQuest003.class);
